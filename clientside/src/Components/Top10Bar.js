...
import React, { Component } from "react";
     ...
     function Top10Bar (props) {

            
    window.addEventListener('load', async function () {
        let response = await fetch(`http://localhost:3000/v1/topten?cid=${props.cid}&cycle=2020`)
        ...
        var layout1 = {
            ...
            width: '600',
            title: {
                text:`Number of PAC vs Individual Contributions by Industry for ${props.name}`,
                    font: {
        ...
        Plotly.newPlot(`bar${props.cid}`, data1, layout1) 

    })
        //each tag is unique to the cid prop
        let IDtag = `bar${props.cid}`
